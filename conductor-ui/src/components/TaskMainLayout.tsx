...
/**
 * Extended main dashboard layout with task decomposition support.
 *
 * This is a drop-in replacement for the MainLayout in App.tsx that adds:
 * - Task decomposition panel as a right sidebar tab
 * - Tab switcher between Human Input and Tasks panels
 * - Auto-selection: human input takes priority (more urgent)
 * - Secondary WebSocket for task_progress event handling
 *
 * +----------------------------------------------------------+
 * | SpawnForm                                                 |
 * +----------+-----------------------+-----------------------+
 ...
 * +----------------------------------------------------------+
 *
 * Integration: Replace <MainLayout /> with <TaskMainLayout /> in App.tsx,
 * or import this component directly in the app entry point.
 */
export function TaskMainLayout() {
